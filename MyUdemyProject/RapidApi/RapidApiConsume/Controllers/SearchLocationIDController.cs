...
namespace RapidApiConsume.Controllers
{
    public class SearchLocationIDController : Controller
    {
        ...
        {
            //burdaki olay şu eğer ki herhangi bir şehir bilgisi girilmez ise
            //hata vermesin diye else kısmında default olarak paris'in bilgilerini alıyorum. Eğer ki herhangi bir şehir bilgisi girilirse o zaman bizim girdiğimiz şehirin bilgisini getiriyo olacak.   

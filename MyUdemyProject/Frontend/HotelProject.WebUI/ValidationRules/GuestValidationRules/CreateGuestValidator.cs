...
{
    public class CreateGuestValidator:AbstractValidator<CreateGuestDto>//biz ekleme işlemi yaparken createGuestDto üzerinde ekleme işlemi yapıyoruz bu yüzden entity değerini guest olarak değil createGuestDto olarak verdim.
    {
        public CreateGuestValidator()//ilgili fluentvalidation komutları constructor metot içerisinde yazılıyor
        {
